...
class API extends REST
{
    ...
    private function cart()
    {
        ...
        $model = new Model();
        $this->response($this->json($model->cart($products, $id_customer, $id_address, $discounts, $deleteDiscount, $msg, $id_cart, $clear)), 200);
    }
    ...
    private function addresses()
    {
        ...
        if (! isset($this->_request['id_address']) || empty($this->_request['id_address'])) {
    ...
    private function postcode()
    {
        ...
        if (! isset($this->_request['postcode']) || empty($this->_request['postcode'])) {
            $this->response('', 204);
        }
    ...
    private function states()
    {
        ...
        if (! isset($this->_request['id_country']) || empty($this->_request['id_country'])) {
            $this->response('', 204);
        }
    ...
    private function cities()
    {
        ...
        if (! isset($this->_request['id_state']) || empty($this->_request['id_state'])) {
            $this->response('', 204);
        }
    ...
    private function colonies()
    {
        ...
        if (! isset($this->_request['id_city']) || empty($this->_request['id_city'])) {
            $this->response('', 204);
        }
    ...
    public function pay()
    {
        ...
        if (isset($this->_request['products']))
        ...
        if (isset($this->_request['discounts']))
            $param['discounts'] = $this->_request['discounts'];
        if (isset($this->_request['msg']))
