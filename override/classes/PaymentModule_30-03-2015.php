...
//valida si tiene doble descuento tanto en la entrada de direccion como en cupon de envio adentro del back office
                    ...
                    if ( $descuentoMoney != "" && $descuentoMoney != 0 ) {
                        ...
                        $order->total_discounts_tax_excl = $descuentoMonetario['totales']['descuento_aplicado'];
                        $order->total_discounts_tax_incl = $descuentoMonetario['totales']['descuento_aplicado'];
                        $order->total_discounts = $descuentoMonetario['totales']['descuento_aplicado'];

                        $order->total_paid_tax_excl = $descuentoMonetario['totales']['total_orden'];
                        $order->total_paid_tax_incl = $descuentoMonetario['totales']['total_orden'];
                        $order->total_paid = $descuentoMonetario['totales']['total_orden'];
                        $order->total_paid_real = $descuentoMonetario['totales']['total_orden'];

                        $order->total_products = $descuentoMonetario['totales']['total_precio_iva_grupal'];
                        $order->total_products_wt = $descuentoMonetario['totales']['total_precio_iva_grupal'];   

                        if ( $descuentoMonetario['totales']['free_shipping'] == 1 ) {
                            $order->total_shipping_tax_excl = 0;
                            $order->total_shipping_tax_incl = 0;
                            $order->total_shipping = 0;
                        }
