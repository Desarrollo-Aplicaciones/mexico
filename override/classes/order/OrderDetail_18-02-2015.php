...
class OrderDetail extends OrderDetailCore {
	...
	protected function create(Order $order, Cart $cart, $product, $id_order_state, $id_order_invoice, $use_taxes = true, $id_warehouse = 0)
	{
        ...
        $validateaddress = $cartobj->validationaddressfarmalisto();
        if ($validateaddress){
            $totalenvio = 0;
        } else {
            $totalenvio = $cartobj->getTotalShippingCost();
        }

        $this->total_shipping_price_tax_excl = $totalenvio;
		$this->total_shipping_price_tax_incl = $totalenvio;
		...
		if ($descuento != "" && $descuento != 0){
			...
			$this->total_price_tax_excl = $this->unit_price_tax_excl * $this->cantiad_producto_recalculo;
			$this->total_price_tax_incl = $this->unit_price_tax_incl * $this->cantiad_producto_recalculo;
			...
			/* 
				...
				echo "this->unit_price_tax_excl: ".$this->unit_price_tax_excl."<br>";
				echo "this->unit_price_tax_incl: ".$this->unit_price_tax_incl."<br>";
