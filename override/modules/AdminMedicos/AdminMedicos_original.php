...
//echo $sql;
    ...
    public function registernewmed() {
    	...
    	foreach ($campos_a_guardar as $key => $value) {
    		...
    		$datos_s .= '"'.strtoupper($this->bd_fielsd_save[$value]).'",';
    	...
    	$ins_medico = "INSERT INTO ". _DB_PREFIX_ ."medico (".$campos_s.") VALUES (".$datos_s.")";
...
*/
    public function registernewesp() {
    	...
    	$ins_visitador_medico = "INSERT INTO ". _DB_PREFIX_ ."especialidad_medica (".$campos_s.") VALUES (".$datos_s.")";
