...
{literal}           
    ...
    <p style="text-align: center; font-weight: bold; font-size: 2em;"> Crear Visitador Médico </p> 
...
{/foreach}
        ...
        <input type="hidden" name="opc_ini" value="creavis">
        <div style="float: left; margin: 3px; margin-top: 60px; text-align: center; width: 100%;"><input type="submit" value="Guardar" name="savenewcreavis"></div>
    </form>
</fieldset>