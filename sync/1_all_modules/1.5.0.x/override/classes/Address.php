...
class Address extends AddressCore
{
	...
	public function add($autodate = true, $null_values = false)
	{
		...
		//Added by tclim - to updated the customer date update
		$this->toggleStatus();
	...
	*/
	...
	{
		//Added by tclim - to updated the customer date update
		Db::getInstance()->Execute('UPDATE `'._DB_PREFIX_.'customer` SET `date_upd` = NOW()	WHERE `id_customer` = '.(int)($this->id_customer));
	}
}
