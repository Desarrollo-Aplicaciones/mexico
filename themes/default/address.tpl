	...
	{foreach from=$ordered_adr_fields item=field_name}
		...
		<p class="required city select">
			...
			<select name="city" id="city">
				<option value="{if isset($smarty.post.city)}{$smarty.post.city}{else}{if isset($address->city)}{$address->city|escape:'html'}{else}{/if}{/if}">{if isset($smarty.post.city)}{$smarty.post.city}{else}{if isset($address->city)}{$address->city|escape:'html'}{else}-{/if}{/if}</option>
			</select>
		</p>
		{*
