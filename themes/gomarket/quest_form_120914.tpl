...
<style type="text/css">
    ...
    #comprarapida{height:  100%;width:  100%;}
     #guest_firstname{width: 196px;}
     #guest_lastnamei{ width: 214px;}
      #dni{width: 216%;}
    #estado{color: #555555;width: 211px;}
...
<div id="comprarapida">
          ...
          <div style="float: left;width: 50%;">
            ...
            <select class="seleccion" id="ciudad" name="city_id" style="width: 105%;color: #555555;">
    ...
    <input type="text" name="phone" style="width:98%" value="{if isset($smarty.post.phone)}{$smarty.post.phone}{/if}">
   </div>
