...
*}
  ...
  <div class="regform">
    <label class="etiqueta">Teléfono<span class="purpura">*</span>:</label>
    <input type="text" name="phone" id="phone" value="{if isset($smarty.post.phone)}{$smarty.post.phone}{/if}" placeholder="10 dígitos según nueva regulación LADA">
