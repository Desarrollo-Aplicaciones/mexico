...
<div id="product_reference" {if isset($groups) OR !$product->reference}style="display: none;"{/if}>
	<div id="globalDiv" >
		<div id="mainDiv" class="mainDiv">
			...
			<div id="image1" class="animacion0" style="width:250px; height:22px">
...
<div id="conconImage">
	<div id="more_info_block" class="clear">
		...
		<div id="more_info_sheets" class="sheets align_justify">
			...
			<div id="idTab1" class="rte content_hide_show">
				...
				<div id="info_confirm">
					<p>La información aquí contenida está dirigida exclusivamente para profesionales de la salud, es necesario confirmar que pertenece a este gremio para tener acceso a la misma.</p>
					<p><input type="checkbox" value="is_prof" id="is_prof" /><span onclick="$('#is_prof').trigger('click');"> Confirmo que soy un profesional de la salud.</span></p>
					<a href="#elementos_redes" onclick="if($('#is_prof').is(':checked'))$('#info_confirm').hide('slow');"><div>Mostrar información</div></a>
				</div>
				{/if}
				<div id="scro">{$product->description}</div>
			</div>
			{/if}
	...
	<div id="informac">
		<a href="https://www.farmalisto.com.mx/content/59-hot-sale-farmalisto-paypal?utm_source=FarmalistoMX&utm_medium=Banner&utm_term=HotSale&utm_content=pdp&utm_campaign=HotSale" target="_self"><img id="imgge" src="{$base_dir}img/cms/landing/pdp/pdp-farmalisto.jpg" style="width: 240px;height: 232px;" alt="Compra OnLine y paga en Efectivo"/></a>
		{* http://www.farmalisto.com.mx/content/28-quienes-somos?utm_source=PDP&utm_medium=BannerPDP&utm_term=ProductDetail&utm_content=Cyberlunes&utm_campaign=0026_16052014
