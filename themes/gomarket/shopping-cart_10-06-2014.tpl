...
background:url({$img_dir}formula-medica/btn-continuar.png)no-repeat top center;
 ...
 -webkit-background-size: 100% 100%;           /* Safari 3.0 */
     -moz-background-size: 100% 100%;           /* Gecko 1.9.2 (Firefox 3.6) */
       -o-background-size: 100% 100%;           /* Opera 9.5 */
          background-size: 100% 100%;margin-top: 0px;margin-bottom: 5px;
}

#processCarrier2:hover
{
padding: 0 0;    
width:145px;
height:40px;
...
#imagenProductoCompra{float:left;width: 125px;height: 100px;}
...
#primerLabel{padding: 31px 70px; color:#676767; text-align: left;margin-top: 0px;padding-top: 0px;}
#segundoLabel{text-align: left;margin-top: 102px;}
#tercerLabel{margin-top: -17px;margin-left: 827px;}
#cuartoLabel{margin-top: -18px;margin-left: 888px;}
#quintoLabel{margin-top: -35px;margin-left: 938px;}
#sextoLabel{margin-top: -18px;margin-right: 881px;}
#precioContenedor{float: right;margin-top: -50px;}
#total_tax{margin-top:-48px; color:#676767; text-align: right;}
#total_product{margin-top: -18px;color: #676767;text-align: right;float: right;}
#total_price_without_tax{margin-top:-48px; color:#676767; text-align: right;}
#descuentoValor{text-align: left;color:#676767; }
#descripcioNombre {margin-left: 0px!important;font-size: 10pt;}
#fila1mp{float: none; height: 100%; width: 100%;}
#cupon input{border-radius: 3px;}
...
@media only screen and (min-width: 768px) and (max-width: 1000px) {
		...
		#totaLabel{margin-top: 38px;width: 98px;}
		#descripcioNombre{margin-left: -15px!important;float: left;font-size: 9pt;}
		...
		#contenedor3contenidos{width:746px;margin-bottom: 20px;}	
        #precioContenedor{margin-top:19px;}
        #total_tax{margin-top: 10px;color: #676767;text-align: right;float: right;}        
		#total_product{margin-top: 14px;color: #676767;text-align: right;float: right;}
		#total_price_without_tax{margin-top: 11px;text-align: right;float: right;}
		#descuentoValor{text-align: left;width: 229px;}
		#segundoLabel {margin-top: -52px;}
		#tercerLabel {margin-left: 452px;}
		#cuartoLabel {margin-left: 548px;}
		#quintoLabel {margin-left: 697px;}
		#sextoLabel {margin-right: 397px;}
		#descuentoLabel{margin-top: 200px;}
		#cajon{display: flex;}
		#imagenProductoCompra {float: left;width: 113px;}
		#descuentoValor{margin-left: 449px;}

}

@media only screen and (min-width: 480px) and (max-width: 767px) {
		
		#primerLabel{padding: 14px 0px;}
		...
		#referenciaLabel {width: 125px;margin-top: 17px;}
		#precioLabel{margin-top: 20px;margin-left: 0px;}
		#cantidadLabel{margin-top: 20px;margin-left: 0px;}
		#totaLabel{margin-top: 20px;}
		#imagenProductoCompra {width: 82px;margin-left: -140px;margin-top: -17px;height: 117px;}
		#descripcioNombre {margin-left: 47px!important;float:left;font-size: 10px!important;margin-top: 13px!important;}
		...
		#contenedorProductos{width: 286px!important;height: 304px;display: inline-flex;margin: 0 0 20px 0;overflow-x: auto;overflow-y:hidden; }
		#boxnefi{width: 56%!important;float: right!important;position: absolute;top: 1042px;}
		#boxmedisp {float: right!important;margin-right: -11px;margin-top: 132px;width: 46%;}
		#cupon{float: left;width: 97%;margin-top: -253px;}
		#contenedor3contenidos {width: 418px;height: 264px;margin-bottom: 20px;}
		#fila1mp{float: left;height: 100%;width: 92%;}
		#total_product {margin-top: -17px;}
		#total_price_without_tax {margin-top: -30px;}
		#total_tax {margin-top: -30px;}
		#precioContenedor {margin-top: -30px;}


}
@media screen and (max-width:480px){
		
		#primerLabel{padding: 14px 3px;text-align: left;width: 85%;font-size: 8pt;margin-left: 0px;}
		#segundoLabel{width: 100%;float: left;font-size: 8pt;}
		#tercerLabel {margin-left: 0px;}
		#cuartoLabel {margin-left: 222px;}
		#quintoLabel {margin-left: 246px;}
		#sextoLabel {margin-right: 196px;}
		ul#order_step {width: 100%;}
		#productoLabel {width: 125px;}
		#referenciaLabel {width: 125px;margin-top: 25px;}
		#precioLabel{margin-top: 20px;margin-left: 0px;}
		#cantidadLabel{margin-top: 20px;margin-left: 0px;}
		#totaLabel{margin-top: 20px;}
		#imagenProductoCompra {width: 82px;margin-left: 0px;margin-top: -17px;}
		#descripcioNombre {margin-left: 40px!important;float:left;font-size: 10px!important;margin-top: 13px!important;}
		#descripcionLabel{width:125px!important;margin-top: 88px!important;margin-left: 0px!important;}
		.cart_ref{font-size: 11px;}
		.cart_product{margin-left: 149px;}
		.totaLabel{margin-left: -34px;width: 125px;}
		#cajon{display: table-caption;width: 134px;height: 330px;float: left;position: relative;}
		#contenedorProductos{width: 186px!important;height: 309px;display: inline-flex;margin: 0 0 20px 0;overflow-x: auto;overflow-y: hidden;}
		#boxnefi{width: 79%!important;float: right!important;position: absolute;top: 1093px;}
		#boxmedisp {float: right!important;margin-right:93px;margin-top: 256px;}
		#cupon{float: left;width: 97%;margin-top: -382px;}
		#contenedor3contenidos {width: 298px;height: 392px;margin-bottom: 20px;}
		#descuentoValor {font-size: 8pt;}
		#total_product{margin-top:-16px;}
		#total_price_without_tax {margin-top: -29px;}
		#total_tax {margin-top: -29px;}
		#precioContenedor {margin-top: -29px;}
...
<h1 id="cart_title" style="margin-top: 8px;width: 70%;float: left;color:#9C9C9C; font-size: 24px; font-family:Verdana; ">Mi Carrito</h1>
...
<p class="cart_navigation1">
	...
	{if !$opc}
		<a id="processCarrier2" href="{if $back}{$link->getPageLink('order', true, NULL, 'step=1&amp;back={$back}')}{else}{$link->getPageLink('order', true, NULL, 'step=1')}{/if}" class="exclusive standard-checkout" title="{l s='Next'}"> </a>
...
<div id="order-detail-content" class="table_block">
	 ...
	 <!-- total Productos -->
		...
		{/if}
			...
			<div class="cart_total_voucher" {if $total_discounts == 0}style="display:none"{/if}>
				...
				<div  style="margin-top: -16px; color:#676767; text-align: right;float: right;margin-right: 0px;" class="price-discount price" id="total_discount">
	...
	{if sizeof($discounts)}
		...
		{foreach $discounts as $discount}
                <div  class="cart_discount {if $discount@last}last_item{elseif $discount@first}first_item{else}item{/if}" id="cart_discount_{$discount.id_discount}" style="float:left;margin-top:64px;">
