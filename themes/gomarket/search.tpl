...
{if !$nbProducts}
	<p class="warning">
		{if isset($search_query) && $search_query}
			Lo lamentamos pero no hay resultados que coincidan con tu búsqueda&nbsp;"{if isset($search_query)}{$search_query|escape:'htmlall':'UTF-8'}{/if}"
 ...
 <h5>Sugerencias:</h5>
 <ul>
 	<li>• Por favor revisa la ortografía de la palabra.</li>
 	<li>• Utiliza palabras más genéricas o menos palabras.</li>
 	<li>• Prueba diferentes palabras clave.</li>
 	<li>• Prueba menos palabras clave.</li>
 	<li>• Navega por  <a href="{$base_dir}mapa-del-sitio"><b>categorías de productos</b></a> para encontrar un producto similar.</li>
 </ul>
