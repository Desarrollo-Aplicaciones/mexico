...
<p><label for="nombre" class="labelform">Archivo formula médica*:</label>
<div class="archivoformula">
    <input style=" width: 100%; height: 100%;   opacity: 0; -moz-opacity: 0;" name="archivoformula" type="file" id="archivoformula" size="28" >
</div>
    </p>
