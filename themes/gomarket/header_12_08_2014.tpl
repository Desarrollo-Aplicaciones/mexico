...
{/if}
		...
		<script type="text/javascript">
			...
			var roundMode = {$roundMode};
                        var ruta = "http://www.farmalisto.com.co/ajax_newsletter.php"; 
		</script>
...
.close {
 ...
 <script type="text/javascript">
	...
	$('#popup').fadeOut('slow');
     ...
     {/literal}
      {if isset($newsletter) && isset($iexplorerold) && $iexplorerold eq true && $newsletter eq true}      
          {literal}
...
{if isset($newsletter)  && isset($iexplorerold) && $newsletter eq true && $iexplorerold eq false}
    {literal}            
  <script type="text/javascript">          
...
{elseif isset($newsletter) && isset($iexplorerold) && $newsletter eq true && $iexplorerold eq true}
