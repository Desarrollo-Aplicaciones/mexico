...
<script src="/js/jquery/plugins/jquery.scrolltofixed.js" type="text/javascript"></script>
<script>
...
<link rel="apple-touch-icon" sizes="180x180" href="img/touch-icon-iphone6P.png" />
<link rel="icon" sizes="192x192" href="img/touch-icon-hq.png"/>
<link rel="icon" sizes="128x128" href="img/touch-icon-lq.png" />
<link rel="icon" sizes="40x40" href="img/touch-icon-40x40.png"/>
	</head>
...
.close {
 ...
 <script type="text/javascript">
	...
	$('#popup').fadeOut('slow');
     ...
     {/literal}
      {if isset($newsletter) && isset($iexplorerold) && $iexplorerold eq true && $newsletter eq true and  $lightboxshow eq 'si'}      
          {literal}
...
{if isset($newsletter)  && isset($iexplorerold) && $newsletter eq true && $iexplorerold eq false and  $lightboxshow eq 'si'}
    {literal}            
  <script type="text/javascript">          
...
{elseif isset($newsletter) && isset($iexplorerold) && $newsletter eq true && $iexplorerold eq true and  $lightboxshow eq 'si'}
