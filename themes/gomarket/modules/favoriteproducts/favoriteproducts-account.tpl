	...
	{if $favoriteProducts}
		<div class="resume">
			...
			<div class="favoriteproduct clearfix">
				<h3 class="name_product"><a href="{$link->getProductLink($favoriteProduct.id_product, null, null, null, null, $favoriteProduct.id_shop)|escape:'htmlall':'UTF-8'}">{$favoriteProduct.name|lower|capitalize|truncate:50}</a></h3>
				...
				<div class="fav_product_price">{convertPrice price=$favoriteProduct.price}{*$favoriteProduct.description_short|strip_tags|escape:'htmlall':'UTF-8'*}</div>
				<div class="remove">
					<img rel="ajax_id_favoriteproduct_{$favoriteProduct.id_product}" src="{$img_dir}/delete.png" alt="" height="80%" width="80%" class="icon" />
				</div>
			</div>
			{/foreach}
		</div>
