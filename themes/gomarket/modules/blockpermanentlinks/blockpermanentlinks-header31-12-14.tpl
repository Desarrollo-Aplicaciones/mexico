...
<ul id="header_links">
	<li id="header_link_contact"><a href="#" class="alrededor">Línea de atención y ventas: 
		<label id="number">DF y &Aacute;rea Metropolitana: (55) 4170.8434 | Nacional: 01 800 269.4408</label></a>
	</li>
