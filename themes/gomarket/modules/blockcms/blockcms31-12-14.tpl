...
{else}
	...
	<div class="block_various_links" id="block_various_links_footer">
		...
		<ul class="f_block_content">
			...
			<li class="item"><a href="http://www.farmalisto.com.mx/content/8-que-es-farmalisto" target="_self" title={l s='¿Qué es farmalisto?' mod='blockcms'}>{l s='¿Qué es farmalisto?' mod='blockcms'}</a></li>
		...
		<div class="block">
		<h4 class="title_block">{l s='Su farmacia en Internet' mod='blockcms'}</h4>
		<a class="show_hide_footer" href="javascript:void(0)">icon</a>
		<ul class="f_block_content">
			...
			<li class="item"><a href="http://www.farmalisto.com.mx/content/6-garantia-del-mejor-precio" target="_self" title="{l s='Garantía del mejor precio' mod='blockcms'}">{l s='Garantía del mejor precio' mod='blockcms'}</a></li>
			<li class="item"><a href="{$link->getPageLink($contact_url, true)}" title="{l s='Cont&aacute;ctenos' mod='blockcms'}">{l s='Cont&aacute;ctenos' mod='blockcms'}</a></li>
