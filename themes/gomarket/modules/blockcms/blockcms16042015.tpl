...
*}
	...
	<div class="social_logo_container">
		<p>Síguenos:</p>
		<a href="https://www.facebook.com/farmalistomexico" alt="facebook farmalisto" target="blank">
			<img src="{$img_dir}footer/Fb.jpg" class="footer_social"/>
		</a>
		<a href="https://twitter.com/farmalistomex" alt="twitter farmalisto" target="blank">
...
{else}
	...
	<div class="block_various_links" id="block_various_links_footer">
		...
		<ul class="f_block_content">
			...
			{* <li class="item"><a href="{$base_uri}?id_cms=8&controller=cms" target="_self" title="{l s='About us' mod='blockcms'}">{l s='About us' mod='blockcms'}</a></li>
			<li class="item"><a href="{$cmslinks.0_3.link|addslashes}" title="{$cmslinks.0_3.meta_title|escape:'htmlall':'UTF-8'}">{$cmslinks.0_3.meta_title|escape:'htmlall':'UTF-8'}</a></li> *}
			<li class="item"><a href="{$cmslinks.0_1.link|addslashes}" title="{$cmslinks.0_1.meta_title|escape:'htmlall':'UTF-8'}">Horarios de Atención</a></li>
{if $display_poweredby}<li class="last_item">{l s='Powered by' mod='blockcms'} <a class="_blank" href="http://www.prestashop.com">PrestaShop</a>&trade;</li>{/if}
		...
		<div class="block">
		<h4 class="title_block">{l s='Online store' mod='blockcms'}</h4>
		<a class="show_hide_footer" href="javascript:void(0)">icon</a>
		<ul class="f_block_content">
			...
			{* <li class="item"><a href="{$link->getPageLink('manufacturer')}" title="{l s='Marcas' mod='blockcms'}">{l s='Marcas' mod='blockcms'}</a></li> *}
			{* <li class="item"><a href="http://www.farmalisto.com.co/content/6-garantia-del-mejor-precio" target="_self" title="{l s='Garantía del mejor precio' mod='blockcms'}">{l s='Garantía del mejor precio' mod='blockcms'}</a></li> *}
			<li class="item"><a href="{$cmslinks.0_1.link|addslashes}" title="{$cmslinks.0_1.meta_title|escape:'htmlall':'UTF-8'}">{$cmslinks.0_1.meta_title|escape:'htmlall':'UTF-8'}</a></li>
			...
			<li class="item"><a href="{$link->getPageLink('sitemap')}" title="{l s='Sitemap' mod='blockcms'}">{l s='Sitemap' mod='blockcms'}</a></li>
		</ul>
		</div>
	{$footer_text}
	</div>
