{if $MENU != ''} 
    ...
    <form method="post" style="display: inline-block;vertical-align: top;display: inline;float: right;margin-top: 11px;margin-top: 31px;float: left;width:101%" action="{$base_dir}ajax_newsletter.php">       
