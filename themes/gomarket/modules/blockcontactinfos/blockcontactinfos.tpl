		...
		<div id="block_contact_infos">
			...
			<ul class="f_block_content">
				...
				{if $blockcontactinfos_phone != ''}
					...
					<a href="tel:+5567321100">{l s='Línea de Atención y Ventas Nacional sin costo:' mod='blockcontactinfos'}<br /><b>{$blockcontactinfos_phone|escape:'htmlall':'UTF-8'}</b></a><br />
				{/if}
