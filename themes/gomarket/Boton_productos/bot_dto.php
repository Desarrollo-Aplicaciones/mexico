...
<div id="globalDiv" style="margin: 0 0; overflow: hidden; transform : translate3d(0,0,0); -moz-transform : translate3d(0,0,0); -ms-transform : translate3d(0,0,0); -o-transform : translate3d(0,0,0); -webkit-transform : translate3d(0,0,0); width:200px; height:35px; ">
<div id="mainDiv" style="margin: 0 auto; overflow: visible; position:relative; width:200px; height:35px;">
    <div id="image0" class="image" style="width:200px; height:35px">
        <img src="537140835127ffwL3stS4l1To8CuJc1js.png" border=0 style="width:200px; height:35px;" />
</div>
    <div id="image1" class="image" style="width:170px; height:28px">
        <img src="53714083818ac1mgnNDYfIAUVt6uHQEDB.png" border=0 style="width:170px; height:28px;" />
</div>
    <div id="image2" class="image" style="width:200px; height:35px">
        <img src="537140835127ffwL3stS4l1To8CuJc1js.png" border=0 style="width:200px; height:35px;" />
</div>
    <div id="image3" class="image" style="width:127px; height:28px">
        <img src="53714083ab11cXhlakdyOo29QcWKzpT7C.png" border=0 style="width:127px; height:28px;" />
...
var slidesObjects_xxx = {width:200, height:35, fromBorder:true, mouseoverPause:"true", autoplay:"true", preloader:"false",progressBar:"false",bullets:"false",nextPrevious:"false",playPause: "false",wmXDistance: 8, wmYDistance: 8, wmLocation: "br", wmURL: "", wmImg: "", wmAlt: "", wmark: "true",totalTime:7, loop:true, goToUrl:'http://www.farmalisto.com.mx/content/28-quienes-somos?utm_source=BotonAnimado&utm_medium=BotonPDP&utm_term=BotonOptin&utm_content=<?php echo $variable;?>&utm_campaign=CampanadeBotones', target:'_blank', 
slides:[{items:[
{id:"image0", url:"", target:"_blank",
     rotation:0,w:200,h:35,src:"537140835127ffwL3stS4l1To8CuJc1js.png", rotationRect:{left:0, top:0}, rect:{left:0, top:0, right:200, bottom:35}, 
...
{id:"image1", url:"", target:"_blank",
     rotation:0,w:170,h:28,src:"53714083818ac1mgnNDYfIAUVt6uHQEDB.png", rotationRect:{left:0, top:0}, rect:{left:0, top:0, right:170, bottom:28}, 
      appear:{effects:["effect_item_scale"], custom_x:0, custom_y:0, x:14, y:4, delay:0, easing:Quad.easeOut, duration:1}
...
{id:"image3", url:"", target:"_blank",
     rotation:0,w:127,h:28,src:"53714083ab11cXhlakdyOo29QcWKzpT7C.png", rotationRect:{left:0, top:0}, rect:{left:0, top:0, right:127, bottom:28}, 
      appear:{effects:["effect_item_scale"], custom_x:0, custom_y:0, x:36, y:3, delay:0, easing:Quad.easeOut, duration:1}
