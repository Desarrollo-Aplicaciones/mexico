...
<div name="opcion1" id = "opcion" onmouseover="mouse_overd('div1');" onmouseout="mouse_outd('div1');">
<p class="payment_module" style="float: left;">
...
<div name="opcion2" id = "opcion" onclick="mouse_overd('div2');" >
<p class="payment_module" style="float: left;">
<a href="#">
