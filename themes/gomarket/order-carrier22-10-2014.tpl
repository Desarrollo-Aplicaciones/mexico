...
<div style="color:#646464; font-size:14px; font-family: 'Open Sans', sans-serif; float: none;">Seleccione una opción para registrar su fórmula médica </div>
...
<div id="editar"  >
    ...
    <div class="item3"><p class="textitulo" >Registrar los datos de su fórmula médica</p></div>
	<div class="item4">
		<p class="textitulo" >Ingrese la información solicitada solo de los medicamentos que requieren formula medica</p>
	</div>
</div>
<!-- fin editar -->
...
<div id="div1" style="display: none;">
	    ...
	    <p class="textapoyo" >Por favor ingrese la información en los campos solicitados, así podremos brindarle un servicio con mayor calidad y efectividad a la hora de tu entrega, si no comprendes los que dice tu prescripción, no te preocupes, tenemos otros métodos, para ingresar la formula médica.
	    </p>
...
<div class="formulario" id="datosmedico" >
	<div style="width:50%; display: inline-block">
		<p class="textitulo"><label for="nombre">Nombre de su Médico*:</label></p>
