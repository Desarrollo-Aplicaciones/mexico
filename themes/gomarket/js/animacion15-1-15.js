...
var clickTag = 'XXXX'; var slidesObjects_xxx = {width:220, height:21, fromBorder:false, mouseoverPause:"true", autoplay:"true", preloader:"true",progressBar:"false",bullets:"false",nextPrevious:"false",playPause: "false",loop:true, goToUrl:'http://www.farmalisto.com.mx/content/28-quienes-somos', target:'_blank', 
		slides:[{items:[
		{id:"image0", url:"", target:"_blank",
		     rotation:0,w:95,h:23,src:"contactanos.png", rotationRect:{left:0, top:0}, rect:{left:0, top:0, right:95, bottom:23}, 
		      appear:{effects:["effect_item_none","effect_item_opacity"], custom_x:0, custom_y:0, x:65, y:-2, delay:0, easing:Quad.easeOut, duration:1}
		      ,disappear:{effects:["effect_item_none","effect_item_opacity"],custom_x:0, custom_y:0, x:65, y:-2, delay:0, easing:Quad.easeOut, duration:1}}],delay:0, bullet:"bullet0", slideDuration:2, slideStopPoint:1},{items:[
		{id:"image1", url:"", target:"_blank",
		     rotation:0,w:175,h:23,src:"DFarea.png", rotationRect:{left:0, top:0}, rect:{left:0, top:0, right:175, bottom:23}, 
		      appear:{effects:["effect_item_none","effect_item_opacity"], custom_x:0, custom_y:0, x:22, y:-2, delay:0, easing:Quad.easeOut, duration:1}
		      ,disappear:{effects:["effect_item_none","effect_item_opacity"],custom_x:0, custom_y:0, x:22, y:-2, delay:1, easing:Quad.easeOut, duration:1}}],delay:0, bullet:"bullet1", slideDuration:3, slideStopPoint:1.5},{items:[
		{id:"image2", url:"", target:"_blank",
		     rotation:0,w:100,h:23,src:"telDF.png", rotationRect:{left:0, top:0}, rect:{left:0, top:0, right:100, bottom:23}, 
		      appear:{effects:["effect_item_none","effect_item_opacity"], custom_x:0, custom_y:0, x:61, y:-2, delay:0, easing:Quad.easeOut, duration:1}
		      ,disappear:{effects:["effect_item_none","effect_item_opacity"],custom_x:0, custom_y:0, x:61, y:-2, delay:2, easing:Quad.easeOut, duration:1}}],delay:0, bullet:"bullet2", slideDuration:4, slideStopPoint:2},{items:[
		{id:"image3", url:"", target:"_blank",
		     rotation:0,w:164,h:23,src:"restopais.png", rotationRect:{left:0, top:0}, rect:{left:0, top:0, right:164, bottom:23}, 
		      appear:{effects:["effect_item_none","effect_item_opacity"], custom_x:0, custom_y:0, x:27, y:-2, delay:0, easing:Quad.easeOut, duration:1}
		      ,disappear:{effects:["effect_item_none","effect_item_opacity"],custom_x:0, custom_y:0, x:27, y:-2, delay:1, easing:Quad.easeOut, duration:1}}],delay:0, bullet:"bullet3", slideDuration:3, slideStopPoint:1.5},{items:[
		{id:"image4", url:"", target:"_blank",
		     rotation:0,w:110,h:23,src:"telres.png", rotationRect:{left:0, top:0}, rect:{left:0, top:0, right:110, bottom:23}, 
		      appear:{effects:["effect_item_none","effect_item_opacity"], custom_x:0, custom_y:0, x:56, y:-2, delay:0, easing:Quad.easeOut, duration:1}
		      ,disappear:{effects:["effect_item_none","effect_item_opacity"],custom_x:0, custom_y:0, x:56, y:-2, delay:2, easing:Quad.easeOut, duration:1}}],delay:0, bullet:"bullet4", slideDuration:4, slideStopPoint:2}]},id='html51393a90f609e9205fdc9fcadf45aefde28a59008fa07', ratio = 1;
