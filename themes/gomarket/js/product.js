...
function updateDisplay()
{
	...
	if (!selectedCombination['unavailable'] && quantityAvailable > 0 && productAvailableForOrder == 1)
	{
		...
		//show the "Agregar al carrito" button ONLY if it was hidden
	...
	else
	{
		...
		//show the 'Agregar al carrito' button ONLY IF it's possible to buy when out of stock AND if it was previously invisible
...
$(document).ready(function()
{
	...
	if (typeof(jqZoomEnabled) != 'undefined' && jqZoomEnabled)
	{
		...
		$('img.jqzoom').jqueryzoom({
			...
			position: "over" //zooming div position(default position value is "right")
		});
	}
