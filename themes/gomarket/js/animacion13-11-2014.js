!function(a,b){
    ...
    "use strict";function a(a,b){var c,d=document.createElement(a||"div");for(c in b)d[c]=b[c];
    return d
}
function b(a){
...
function c(a,b,c,d){
    var e=["opacity",b,~~(100*a),c,d].join("-"),f=.01+c/d*100,g=Math.max(1-(1-a)/b*(100-f),a),h=k.substring(0,k.indexOf("Animation")).toLowerCase(),i=h&&"-"+h+"-"||"";return m[e]||(n.insertRule("@"+i+"keyframes "+e+"{0%{opacity:"+g+"}"+f+"%{opacity:"+a+"}"+(f+.01)+"%{opacity:1}"+(f+b)%100+"%{opacity:"+a+"}100%{opacity:"+g+"}}",n.cssRules.length),m[e]=1),e
}
function d(a,b){
    var c,d,e=a.style;
...
var clickTag = 'XXXX'; var slidesObjects_xxx = { fromBorder:true, mouseoverPause:"true", autoplay:"true", preloader:"false",progressBar:"false",bullets:"false",nextPrevious:"false",playPause: "false", loop:true, goToUrl:'http://www.farmalisto.com.co/content/28-quienes-somos', target:'_blank', 
slides:[{items:[
{id:"image0", url:"", target:"_blank",
     rotation:0,w:164,h:22,src:"comunicate.png", rotationRect:{left:0, top:0}, rect:{left:0, top:0, right:164, bottom:22}, 
      appear:{effects:["effect_item_scale"], custom_x:0, custom_y:0, x:32, y:2, delay:0, easing:Quad.easeOut, duration:0.3}
      ,disappear:{effects:["effect_item_none","effect_item_opacity"],custom_x:0, custom_y:0, x:32, y:2, delay:3.4, easing:Quad.easeOut, duration:0.3}}],delay:0, bullet:"bullet0", slideDuration:4, slideStopPoint:2},{items:[
{id:"image1", url:"", target:"_blank",
     rotation:0,w:226,h:22,src:"tel_bog.png", rotationRect:{left:0, top:0}, rect:{left:0, top:0, right:226, bottom:22}, 
      appear:{effects:["effect_item_scale"], custom_x:0, custom_y:0, x:0, y:2, delay:0, easing:Quad.easeOut, duration:0.3}
      ,disappear:{effects:["effect_item_none","effect_item_opacity"],custom_x:0, custom_y:0, x:0, y:2, delay:3.4, easing:Quad.easeOut, duration:0.3}}],delay:0, bullet:"bullet1", slideDuration:4, slideStopPoint:2},{items:[
{id:"image2", url:"", target:"_blank",
     rotation:0,w:172,h:22,src:"tel_nac.png", rotationRect:{left:0, top:0}, rect:{left:0, top:0, right:172, bottom:22}, 
      appear:{effects:["effect_item_scale"], custom_x:0, custom_y:0, x:28, y:2, delay:0, easing:Quad.easeOut, duration:0.3}
      ,disappear:{effects:["effect_item_none","effect_item_opacity"],custom_x:0, custom_y:0, x:28, y:2, delay:3.4, easing:Quad.easeOut, duration:0.3}}],delay:0, bullet:"bullet2", slideDuration:4, slideStopPoint:2}]},id='html5408d545da38bf4da9aacbf9d6415d21c3dded408bb03', ratio = 1;
...
function addBullets() {
    ...
    for (var bulletsIndex in bulletsArray) {
        ...
        if (controlsInitialized == false) {
            $theBullet = insertBullet("bullets", bulletId, slidesObjects_xxx.bulletImg, "Play", "animacion2");
        } else {
