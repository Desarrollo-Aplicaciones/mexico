...
<h1>{if !isset($email_create)}{l s='Ingreso al Sistema'}{else}{l s='Crear una cuenta'}{/if}</h1>
		...
		<fieldset>
			...
			<div class="form_content clearfix">
				...
				<p class="submit">
					...
					<input type="submit" id="SubmitCreate" name="SubmitCreate" class="button_large" value="{l s='Crear una cuenta'}" />
	...
	<form action="{$link->getPageLink('authentication', true)}" method="post" id="login_form" class="std">
		<fieldset>
			...
			<div class="form_content clearfix">
				...
				<p class="submit">
					{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'htmlall':'UTF-8'}" />{/if}
					<input type="submit" id="SubmitLogin" name="SubmitLogin" class="button" value="{l s='Ingresar al sistema'}" />
				</p>
			...
			<div id="opc_account_form" style="display: block; ">
				...
				{if isset($newsletter) && $newsletter}
					<p class="checkbox">
						...
						<label for="newsletter">{l s='Recibir el boletin de noticias!'}</label>
					</p>
					<p class="checkbox">
						...
						<label for="optin">{l s='recibir ofertas de nuestros aliados!'}</label>
					</p>
				{/if}
