...
<div id="product_reference" {if isset($groups) OR !$product->reference}style="display: none;"{/if}>
	<div id="globalDiv" >
		<div id="mainDiv" class="mainDiv">
		    <!-->div id="image0" class="animacion0" style="width:164px; height:22px">
				<img src="{$img_dir}comunicate/comunicate.png" border=0 style="width:164px; height:22px;" />
			</div>
			<div id="image1" class="animacion0" style="width:226px; height:22px">
				<img src="{$img_dir}comunicate/tel_nac.png" border=0 style="width:226px; height:22px;" />
			</div>
			<div id="image2" class="animacion0" style="width:172px; height:22px">
				<img src="{$img_dir}comunicate/tel_bog.png" border=0 style="width:172px; height:22px;" />
			</div>
			<div id='bullets' class='animacion1' ></div-->
			<div class="contactanos">Contactanos: (55) 4170.8434</div>
		</div>
	...
	<div class="our_price_display" id="our_price_display2">
		...
		<div id="conteDescuento">
			<span style="color: #8D2F2B;font-weight: 600!important;font-size: 11px!important;font-family: 'Open Sans', sans-serif!important;"><!-- Valor restante para envío gratuito -->
				...
				Tu env&#237;o gratis por compras superiores a <br>{convertPrice price=$valor_restante} en M&eacute;xico DF.
