...
<div style="diplay:block; width: 100%; height: auto;">
        ...
        <input type="checkbox" name="same" id="addressesAreEquals" value="1" checked="checked" style="visibility:hidden;"/>
            ...
            <div class="direccion">
                    <div style="display: table-cell;vertical-align:middle;">
                        <input style="margin-right: 15px;" type="radio" id="rb{$nr['id_address']}" name="id_address_delivery" value="{$nr['id_address']}" onchange="enable({$nr['id_address']});updateAddressesDisplay();{if $opc}updateAddressSelection();{/if}" {if $nr['id_address'] == $cart->id_address_delivery}checked="checked"{/if}"/>
                    </div>
                    ...
                    {if $nr['express'] && $expressEnabled}
                    <div class="express" id="texto_{$nr['id_address']}" {if $nr['id_address'] == $cart->id_address_delivery}style="color:#39CB98" {/if}>
    ...
    <div class="contenedor" id="nueva-direccion">
        ...
        <div style="min-width: 50%; max-width: 95%; display: inline-block;">
            ...
            <input class="entrada" type="text" value="" placeholder="ingresa tu número fijo" id="fijo" name="fijo"/>
        </div>
        <div style="min-width: 50%; max-width: 95%; display: inline-block;">
            <p class="etiqueta" id="label-movil">Teléfono Móvil*:</p>
            <input class="entrada" type="text" value="" placeholder="ingresa tu número móvil" id="movil" name="movil"/>
        </div>
        </div>
        <div>
            <div style="width: 100%; display: inline-block;">
                <p class="etiqueta" id="label-direccion">Dirección*:</p>
                <input class="entrada larga" type="text" value="" placeholder="Calle, # exterior, # interior" id="direccion" name="direccion"/>
            </div>
        </div>
        <div>
            <div style="width: 100%; display: inline-block;">
        ...
        <div>
            <div style="width: 100%; display: inline-block;">
                ...
                <input class="entrada larga" type="text" value="" placeholder="Por favor asigna un nombre a esta dirección para futuras referencias" id="alias" name="alias"/>
            </div>
        </div>
        <div>
