...
<script type="text/javascript">
  ...
  $( "#depostito_efectivo" ).change(function() {
...
$(function() {
    alert("Test");
    console.log("XD - XD");
    $("#depostito_efectivo").change({
    console.log("Cambio el elemento:  depostito_efectivo");
        });
       var value= $( "#depostito_efectivo" ).val();
       console.log(value);
...
<div class="botones">
	<a href="{$link->getPageLink('order', true, NULL, "step=1")}" id="navegarAtras2" title="{l s='Previous'}" ></a>
	<input type="button"  name="botoncitosubmit" id="botoncitosubmit" class="botoncitosubmit1">
</div>
<div id="uls">{if !$opc}
...
{if !$opc}
	...
	<div id="botonesInferiores">
		<a href="{$link->getPageLink('order', true, NULL, "step=1")}" id="navegarAtras" title="{l s='Previous'}" ></a>
