...
<!-->div class="imagen_medios"><img src="{$img_dir}authentication/efecty.png" width="100%"/></div-->
	...
	{/if}
	     ...
	     <div class="en_cuenta">
	     	<p class="mind_title">{l s='Keep in mind'}:</p>
	     	<ul>
	     	<li class="mind_content">- Costos de envío: Para Pedidos mayores a <b>$300.00</b> la entrega es <b>GRATIS</b> al día siguiente y <b>$29.00</b> el mismo día,
	     	en pedidos menores a <b>$300.00</b> el costo de entrega es de <b>$29.00</b> al día siguiente y <b>$59.00</b> el mismo día. 
	     	Para el interior de la República todo envío es de <b>$99.00</b></li>
	     	<li class="mind_content">- Medios de Pago: <b>Efectivo</b> contra entrega (Aplica sólo en Distrito Federal y &Aacute;rea Metropolitana*) <b>Oxxo, 7 Eleven, depósito o transferencia bancaria, tarjeta de crédito y débito.<br />
	     	*Efectivo contra entrega por su seguridad de limita a pedidos iguales o menores a $2,000.00</b></li>
	     	</ul>
	     </div>
	...
	{*	{if $use_taxes}
		...
		{/if}
			...
			{if sizeof($discounts)}
				<div id="cupon">
						<div class="suc_dis">{l s='Successful code'}</div>
				</div>
	...
	{if $voucherAllowed}
		...
		<form action="{if $opc}{$link->getPageLink('order-opc', true)}{else}{$link->getPageLink('order', true)}{/if}" method="post" id="voucher">
			<fieldset>
                            <p class="label_cupon">Ingresa el nombre de tu <br/>
                            <input type="radio" name="type_voucher" value="md" > <b>Médico &nbsp; &nbsp;&nbsp; 
	...
	{/if}
			...
			<div class="cart_total_price total" >				
				<div  id="primerLabel">{l s='Subtotal:'}</div>
				{if $use_taxes}
