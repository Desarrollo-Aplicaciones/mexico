...
<div style="diplay:block; width: 98%; height: auto;">
    ...
    <div class="contenedor" id="primera_columna">
        ...
        {/if}
            ...
            <div class="agregaNueva" onclick="standard_lightbox('nueva-direccion');"><span>+ </span> &nbsp; &nbsp; Agregar nueva dirección</div>
    </div>
    <!-- ************************** FIN PRIMERA COLUMNA ****************************-->            
    <!-- ************************** SEGUNDA COLUMNA ****************************-->
    <div class="contenedor container_24" id="nueva-direccion">
        <div>
        ...
        <div style="display:inline-block; margin-top:20px">
        	<a href="#" onclick="lightbox_hide();" class="cancelar">Cancelar</a>
...
{if $expressEnabled && $express_productos}
<div id="confirmExpress" style="display:none" >
    <div class="confirmExpress" style="z-index:101;top:235px;">
        <div class="invisible">
            <div class="titleConf">Confirmación</div>
            <div class="visible"></div>
        </div>
    </div>
    <div class="confirmExpress">
        <div class="confirmxps">
            <br />El pedido llegará en máximo <b>90 minutos</b><br />el costo del servicio express es de <span id="xpsValue"></span><br /> ¿Activar este servicio?<br /><br />
            <div id="xpscancel">&laquo; No, Cancelar</div>
            <div id="xpsaccept">Si, Aceptar &raquo;</div>
        </div>
    </div>
</div>
{/if}
