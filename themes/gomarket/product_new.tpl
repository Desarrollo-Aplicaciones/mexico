...
<div id="primary_block" class="clearfix">
	...
	<div id="pb-right-column">
		...
		<ul id="usefull_link_block">
			...
			{/if}
                ...
                <br>
    <p style="text-justify: auto;" >Bienvenido a Farmalisto, tu droguería online, encontrarás productos de farmacia, salud, nutrición, cuidado personal y para la familia. Compra y haz tus pedidos fácilmente, servicio a domicilio en Bogotá, Medellín, Cali, Barranquilla, Bucaramanga, Cúcuta, Ibagué, Pereira, Pasto y demás ciudades de Colombia, garantizamos el mejor precio. Acá te decimos para qué sirve cada producto.</p>
	...
	<div id="pb-left-column">
		...
		{if $product->quantity <= 0}<span class="outofstock">{l s='Agotado'}</span>{else}<span class="availability">{l s='Disponible'}</span>{/if}
		...
		<div class="cs_price price">
				...
				{if $priceDisplay >= 0 && $priceDisplay <= 2}
					<span id="our_price_display">Precio: {convertPrice price=$productPrice}</span>
		...
		<div class="content_prices clearfix">
			...
			{else}
				<p id="add_to_cart" class="buttons_bottom_block">
					<input type="submit" name="Submit" value="{l s='Agregar al Carrito'}" class="exclusive" />
				</p>
			{/if}
...
<div id="more_info_block" class="clear">
	...
	{if isset($attachments) && $attachments}
		<ul id="idTab9" class="bullet content_hide_show">
