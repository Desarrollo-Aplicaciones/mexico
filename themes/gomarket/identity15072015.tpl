...
{else}
	...
	<form action="{$link->getPageLink('identity', true)|escape:'html'}" method="post" class="std">
		<fieldset>
			...
			<p id="security_informations">{literal}<style type="text/css">.tyc:hover{color:#000000!important;}</style>{/literal}
				<a href="{$base_dir}index.php?id_cms=3&controller=cms" class="tyc" target="_blank" >Términos y Condiciones del Sitio Web</a>
			</p>
		</fieldset>
	</form>
{/if}
