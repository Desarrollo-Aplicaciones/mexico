...
<a href="{$base_dir}override/Boton_productos/bot_dto.php?idproducto={$product->id}">
<iframe src="{$base_dir}override/Boton_productos/bot_dto.php?idproducto={$product->id}" style="border: none;
