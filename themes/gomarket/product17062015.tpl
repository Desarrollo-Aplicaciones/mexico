...
$('#boton').unbind('click').live('click', function(){
...
<div class="tittle_bar">
	...
	<div class="product_title" >
		...
		{/if}
		<div>{$product->name|lower|capitalize}</div>
	</div>
</div>
<!--/Fin barra Título + social-->
<div class="contenido_producto">
	...
	<div id="views_block">
		...
		<div id="thumbs_list">
			{if $url_manufacturer neq "" AND $url_manufacturer neq 0}
			<a class="resp_fact" href="{$base_dir}{$url_manufacturer}">
				<img src="{$base_dir}{$img_manufacturer}">
			</a>
			{/if}
	...
	<div class="ben_col">
		<div class="beneficio">
			<div class="img_ben"><img src="{$img_dir}pdp/b_rx.png" alt="Toda la receta médica en un solo lugar"/></div>
			<div class="des_ben">Toda la receta médica en un solo lugar</div>
		</div>
		<div class="beneficio">
...
<script type='text/javascript' src='{$js_dir}pdp/boton.js'></script>
		...
		<div class="beneficio_resp">
			<img src="{$img_dir}pdp/b_rx.png" alt="Toda la receta médica en un solo lugar"/>
	...
	<div id="conconImage">
		<div id="more_info_block" class="clear">
			...
			<div id="more_info_sheets" class="sheets align_justify">
				...
				{if $features}<div class="title_hide_show">{l s='Data sheet'}</div>{/if}
				{if isset($features) && $features}
				<!-- product's features -->
				<ul id="idTab2" class="rte bullet content_hide_show"><div id="scro">
				...
				<div id="idTab1" class="rte content_hide_show">
					...
					<div id="info_confirm">
						...
						<input type="checkbox" value="is_prof" id="is_prof" /><span onclick="$('#is_prof').trigger('click');"> Confirmo que soy un profesional de la salud.</span></p>
...
<div id="buyConfirm">
	...
	<div class="lightbox_resume">
		<img class="lightbox_img" src={if $have_image}"{$link->getImageLink($product->link_rewrite, $cover.id_image, 'medium_default')}"{else}"{$img_prod_dir}{$lang_iso}-default-medium_default.jpg"{/if} alt="{$product->name|escape:'htmlall':'UTF-8'}" />
...
<div id="product_voucher">
	...
	<div class="tos">*El cupón sólo se hará válido en la primera compra, no es acumulable con otras promociones. Para más información escríbir a contacto@farmalisto.com.co</div>
</div>
