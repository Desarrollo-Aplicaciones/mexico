 ...
 -webkit-background-size: 100% 100%;           /* Safari 3.0 */
     -moz-background-size: 100% 100%;           /* Gecko 1.9.2 (Firefox 3.6) */
       -o-background-size: 100% 100%;           /* Opera 9.5 */
		...
		<img id="thumb_{$image.id_image}" src="{$link->getImageLink($product->link_rewrite, $imageIds, 'medium_default')}" alt="{$image.legend|htmlspecialchars}" style="border-radius: 3px;height: 57px;margin-top: 0px;width: 98%;"/></div>
			</a>
		</li>
		{/foreach}
		{/if}
...
*}
				...
				<div id="conteDescuento">
					...
					Recuerda que te faltan <br>{convertPrice price=$valor_restante} para que tu env&iacute;­o sea gratuito.
...
<div id="conconImage">
	...
	<div id="informac">
		<div style="float: left;">
			...
			<div id="labeles">
				<label id="TextoGrileta">Comunicate <label id="colorTexto">gratis</label> con nosotros en el <label id="colorTexto">018000 913 3830</label> y en Bogotá al <label id="colorTexto">220 5249</label>.</label>
			</div>
		</div>
