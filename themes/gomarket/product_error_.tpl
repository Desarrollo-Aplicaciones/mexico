 ...
 -webkit-background-size: 100% 100%;           /* Safari 3.0 */
     -moz-background-size: 100% 100%;           /* Gecko 1.9.2 (Firefox 3.6) */
       -o-background-size: 100% 100%;           /* Opera 9.5 */
		...
		<img id="thumb_{$image.id_image}" src="{$link->getImageLink($product->link_rewrite, $imageIds, 'mediudefault')}" alt="{$image.legend|htmlspecialchars}" style="border-radius: 3px;height: 56px;margin-top: 0px;width: 98%;"/></div>
			</a>
		</li>
		{/foreach}
		{/if}
...
<div id="conconImage">
	...
	<div id="informac">
		<a href="http://www.farmalisto.com.co/775-para-vacaciones?n=200&utm_source=PDP&utm_medium=BannerPDP&utm_term=ProductDetail&utm_content=Vacaciones&utm_campaign=0011_08042014" target="_blank"><img id="imgge" src="{$img_dir}zonaPublicitaria/pdp.jpg" style="width: 240px;height: 232px;" alt="Los productos para tus vacaciones"/></a>
