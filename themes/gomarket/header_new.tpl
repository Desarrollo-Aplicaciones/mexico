...
{$HOOK_HEADER}
	...
	<body {if isset($page_name)}id="{$page_name|escape:'htmlall':'UTF-8'}"{/if} class="{if $hide_left_column}hide-left-column{/if} {if $hide_right_column}hide-right-column{/if} {if $content_only} content_only {/if}">
		<div id="superior1" style="width: 100%; background: url({$base_dir}themes/gomarket/img/bar-header1.png) repeat-x scroll left top rgba(0, 0, 0, 0) !important; position: fixed; width: 2000px; height: 35px;"> </div>
		<div id="superior2" style="width: 100%; background: linear-gradient(#9ED67E, #6F9F52) repeat scroll 0 0 rgba(0, 0, 0, 0) !important; position: fixed; width: 2000px; height: 40px; top:40px;"></div>
	{if !$content_only}
			...
			<div class="mode_header" id="mode_header">
				<div class="container_24">
				    ...
				    <form method="post" action="{$base_dir}ajax_newsletter.php" >  
				    	<div id="news_top_one" style="float: right;">     
				        ...
				        <div id="news_top_two" style="float: right;">
...
{if isset($newsletter) and $newsletter eq 'newsletter'}
...
.content-news {
	...
	background-color:#FFFFFF;
	box-shadow: 0 2px 5px #666666;
        background: url('{$base_dir}img/newsletter.png') no-repeat;
}
...
#hombre1 {
       background:url('{$base_dir}img/news-hombre.png') no-repeat;
...
height:43px;
border:none;
    background:url('{$base_dir}img/news-hombre-hover.png') no-repeat;
    -webkit-background-size: 100% 100%;           /* Safari 3.0 */
    -moz-background-size: 100% 100%;           /* Gecko 1.9.2 (Firefox 3.6) */
    -o-background-size: 100% 100%;           /* Opera 9.5 */
    background-size: 100% 100%;
...
#mujer1{
    background:url('{$base_dir}img/news-mujer.png') no-repeat;
    -webkit-background-size: 100% 100%;           /* Safari 3.0 */
    -moz-background-size: 100% 100%;           /* Gecko 1.9.2 (Firefox 3.6) */
    -o-background-size: 100% 100%;           /* Opera 9.5 */
    background-size: 100% 100%;
...
height:43px;
border:none;
    background:url('{$base_dir}img/news-mujer-hover.png') no-repeat;
    -webkit-background-size: 100% 100%;           /* Safari 3.0 */
    -moz-background-size: 100% 100%;           /* Gecko 1.9.2 (Firefox 3.6) */
    -o-background-size: 100% 100%;           /* Opera 9.5 */
    background-size: 100% 100%;
