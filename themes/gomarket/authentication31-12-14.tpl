...
<span class="titulo">Ingreso de usuarios registrados</span>
...
<div style="display:table-cell;float:left;"><input type="submit" id="SubmitLogin" name="SubmitLogin" value="Ingresar" ></div>
<div style="display:table-cell;float:right;margin: 10px 13px 0 0;"><a class="olvida" style="font-size: 9pt;" href="{$link->getPageLink('password')}">{l s='Forgot your password?'}</a></div>
</div>
</fieldset>
</form>
</div>
...
<div class="contenedor" id="segundoHole">
                    {if  isset($GUEST_FORM_ENABLED) &&$GUEST_FORM_ENABLED }  
                          <div class="titulo"><input type="radio" id="opregistrado" name="opcompra" checked="checked">Crear una cuenta</div>
                         <div class="titulo"><input type="radio" id="opinvitado" name="opcompra"   {if isset($comprarapida)}  checked="checked"  {/if}>Compra rápida</div>
                      {else}
                          <div class="titulo">Crear una cuenta</div>
                      {/if}
<div class="obliga">(*) Campos Obligatorios</div>
...
<p class="form-registro" id="label-gender">{l s='Sexo*:'}</p>
...
<p class="form-registro" id="label-email">{l s='E-mail'}*:</p>
...
<p class="form-registro" id="label-passwd">{l s='Password'}*:</p>
<input type="password" style="width: 90%;" name="passwd" id="passwd" selector="clave"/>
</div>
<div style="display:table-cell; float:left; width: 48%; ">
<p class="form-registro" id="label-conf" style="margin-left: 10px">{l s='Confirma Contraseña*:'}</p>
<input type="password" style="width: 90%; float:right;" name="conf-passwd" id="conf-passwd" selector="confirma"/>
</div>
</div>
<div>
<div style="display:table-cell; float:left; width: 48%; ">
<p class="form-registro" id="label-first">{l s='First name'}*:</p>
...
<div style="display:table-cell; float:left; width: 48%; ">
<p class="form-registro" style="margin-left: 10px;" id="label-last">{l s='Last name'}*:</p>
...
<div>
<div style="display:table-cell; float:left; width: 48%; ">
<p class="form-registro" id="label-id">{l s='Tipo documento*:'}</p>
...
<div style="display:table-cell; float:left; width: 48%; ">
<p class="form-registro" style="margin-left: 10px;" id="label-dni">{l s='Identificación*:'}</p>
<input type="text" style="width: 90%; float:right;" id="dni" name="dni" />
</div>
</div>
<div>
<div style="display:table-cell; float:left; width: 100%; ">
<p class="form-registro" id="label-birth">{l s='Date of Birth'}*:</p>
<div>
...
{/if}
  ...
  <!-- quest form --  formulario  modo invitado-->     
      {if isset($GUEST_FORM_ENABLED) &&$GUEST_FORM_ENABLED }   {include file="$tpl_dir./quest_form.tpl"} </div> {/if}
...
<div class="seguridad">
	...
	<div id="seguridadTitulo">Realiza tu compra con tranquilidad, contamos con certificación de seguridad.</div>
	<div style="font-size:7pt;display:none;">* <b>Absoluta</b> discreción</div>
	<div style="font-size:7pt;display:none;">* Mejor precio <span style="color:#b7689e">Garantizado*</span></div>
	<div><img src="{$img_dir}authentication/g644.png" id="seguridadImagen"/></div>
</div>
