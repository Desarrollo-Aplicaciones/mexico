...
<div id="opciones" name="payPal" onclick="mouse_overd('divPay');">
	...
	<div class="payment_module" id="textPay">
		...
		{l s='Pay with PayPal' mod='paypalusa'}
	</div>
</div>
	...
	<div class="contendfrom">
		<form action="{$paypal_usa_action|escape:'htmlall':'UTF-8'}" method="post">
			<p class="payment_module">
				...
				<input id="paypal-standard-btn" type="image" name="submit" src="{$base_dir}modules/paypalusa/img/submit.png" alt="" style="vertical-align: middle; margin-right: 10px;border:0;" />
			</p>
		</form>
	</div>
</div>