...
<style>
	...
	@media only screen and (min-width:1001px)  {
		#banner_970 { display: block; float: right; width: 1000px; height: auto; padding-bottom: 20px; max-height: 90px;}
		#banner_970_in { width: 970px; height: 90px; margin: 0px 0px 0px 0px;  max-height: 90px;}
		.imagen_ban_970LR { width: 425px; height: 8px;}
		...
		.hook_csslide_new { width: 100% !important; }
		#new-products_block_right { margin-left: 0px !important; }
