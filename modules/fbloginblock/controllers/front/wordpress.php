...
class FbloginblockWordpressModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        include_once(_PS_MODULE_DIR_.$name_module.'/classes/wordpresshelp.class.php');
