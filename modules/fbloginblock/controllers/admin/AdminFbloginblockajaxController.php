...
class AdminFbloginblockajaxController extends ModuleAdminController
{


    public function ajaxProcessFbloginblockAjax()
    {
        ...
        if(Tools::getValue('token') == Tools::getAdminTokenLite('AdminFbloginblockajax')) {
