...
class paymentEfecty extends FrontController
{
	...
	public function displayContent()
	{
		...
		self::$smarty->display(_PS_MODULE_DIR_.'payulatam/tpl/payuEfecty.tpl');
	}
...
$payUController = new paymentBaloto();
$payUController->run();
