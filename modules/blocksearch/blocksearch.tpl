...
<div id="search_block_left" class="block exclusive">
	...
	<form method="get" action="{$link->getPageLink('search', true)|escape:'html'}" id="searchbox">
		<p class="block_content">
			<label for="search_query_block">{l s='Digite nombre de producto o descripci&ocute;n' mod='blocksearch'}</label>
			...
			<input type="submit" id="search_button" class="button_mini" value="{l s='Buscar!' mod='blocksearch'}" />
		</p>
	</form>
</div>
