...
class AdminOrdersControllerCore extends AdminController
{
	...
	public function __construct()
	{
		...
		$statuses = OrderState::getOrderStates((int)Context::getContext()->language->id,(int)$this->context->employee->id_profile);
...
/*botón crear una orden*/
	...
	public function renderView()
	{
		...
		$this->tpl_view_vars = array(
            ...
            'stop_order_step'=>Configuration::get('PS_STOP_ORDER_STEP')
		);
