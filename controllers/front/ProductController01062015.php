...
class ProductControllerCore extends FrontController
{
 ...
 $img_manufacturer='../img/tmp/farmalisto-laboratorios.jpg'; 
  ...
  if (file_exists('img/m/'.$this->product->id_manufacturer.'-small_lab_pdp.jpg')) {
    ...
    $url_manufacturer = $this->product->id_manufacturer."_".$manufacturerC->getLink();
			...
			$this->context->smarty->assign(array(
				...
				'product_manufacturer' => $manufacturerC,
				...
				'isformula'=>$this->is_formula($this->product->getFrontFeatures($this->context->language->id)),
				'isboton'=>$this->is_boton($this->product->getFrontFeatures($this->context->language->id)),
				'isrequired'=>$this->caracteristica($this->product->getFrontFeatures($this->context->language->id), 'Información de uso médico'),
				'valor_restante' => $val_restante ,
