...
//$session_id=$this->context->smarty->tpl_vars['token']->value;
	...
	$query = "select mediosp.id_medio_de_pago,mediosp.Activo, IF (ISNULL(pepe.id_medio_de_pago),0,1) as inrule,mediosp.nombre, mediosp.type, mediosp.max_amount   
...
// listado de medios de pago disponibles
        ...
        foreach ($result as $key => $value) {
        	$output[$value['nombre'].'_max_amount'] = $value['max_amount']; 
        }
