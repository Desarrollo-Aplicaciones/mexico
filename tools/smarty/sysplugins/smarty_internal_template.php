    ...
    public function compileTemplateSource()
    {
        ...
        if (!$this->source->recompiled && $this->compiler->write_compiled_code) {
            ...
            try {
                ...
                /** Inicio creacion archivo limpia cache
                * [$fp Para crear archivo q posteriormente limpia cache si esta creado]
                * @var [type] File
                */
                $fp=fopen("/var/www/cache_flag/clear_cache_smarty","a+");
                fwrite($fp,date("Y-m-d H:i:s").' - No se pudo escribir en el archivo: '.$_filepath." | Exception: ".$e);
                fclose($fp) ;
                /* Fin creacion archivo limpia cache */ 
            }
