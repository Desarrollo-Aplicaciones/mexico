...
class OrderHistoryCore extends ObjectModel
{
	...
	public function changeIdOrderState($new_order_state, $id_order, $use_existing_payment = false)
	{
		...
		$this->logtxt('1) new_order_state: '.$new_order_state);
		...
		$this->logtxt('2) order_id: '.$order->id.',  order_current_state: '.$order->current_state.", id_order_state: ".$this->id_order_state);
		$order->update();
		$this->logtxt('3) order_id: '.$order->id.',  order_current_state: '.$order->current_state.", id_order_state: ".$this->id_order_state);
