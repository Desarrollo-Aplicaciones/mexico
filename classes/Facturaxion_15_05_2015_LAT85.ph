  ...
  return $cfdi;
	 ...
	 */
		...
		public function solicitud2( $metodo_pago, $cupon, $list_products, $invoice_address, $order_tot, $estado_orden = 0, $obligar_timbrado = 0) {
			...
			//exit;
			if ( ( ( !is_array($valor_timbrado) && $valor_timbrado == 0 ) && !file_exists($xml_previamente_generado) && $estado_orden == 4 ) || $obligar_timbrado == 1 )  {
			...
			//if ( !file_exists($xml_previamente_generado) ) {		
				...
				*/
				...
				$buscar_dato_en_xml = array( "<sup>FM</sup>", '"', "<", ">", "&", "ñ", "Ñ", "#", "á", "é", "í", "ó", "ú", "Á", "É", "Í", "Ó", "Ú", "(", ")" );
				$reemplaza_dato_en_xml = array( "", "", "", "", "", "n", "N", "No", "a", "e", "i", "o", "u", "A", "E", "I", "O", "U", "", "" );
				...
				foreach ($list_products as $key_prod => $value) {
					...
					$arr_xml_cargar_p['ar6to67be_Conceptos']['ar6to67be_Concepto'][$cant_prods]['@attributes']['descripcion'] = trim( $this->stripAccents( $list_products[$key_prod]['product_name'] ) );
						...
						if ( isset( $cupon ) && $cupon != null && $cupon['reduction'] != '' ) {
							...
							if ( $cupon['tipo'] == 'porcentaje' ) {
								...
								if ( $order_tot->id == $orden_validar  ) {
									...
									echo "<br> val acumulado total de iva :".//number_format( 
				...
				$arr_xml_cargar['@attributes']['sello'] = ('QKJ4porjBgJvkalKBE4Ym8vISbltWesL9Ra4vQUxAEsQyDqF5+2No5dioIpulBB+NsHt3e6BW2ZjblaTnZQEZGXXVL+jw7P9eXriSWu49hbNyeW0hYhDz/jyxtyXE0h2l1s0H/dkFamlk0flUkA8ub+S5HfOIfFKkfH1sROgrjk=');
				...
				//$arr_xml_cargar['@attributes']['TipoCambio'] = '13.5';
					...
					$arr_xml_cargar['ar6to67be_Emisor']['@attributes']['nombre'] = $this->RFCEmisor_nombre;
						...
						$arr_xml_cargar['ar6to67be_Emisor']['ar6to67be_DomicilioFiscal']['@attributes']['calle'] = 'Mexicali';
						$arr_xml_cargar['ar6to67be_Emisor']['ar6to67be_DomicilioFiscal']['@attributes']['noExterior'] = '4';
						$arr_xml_cargar['ar6to67be_Emisor']['ar6to67be_DomicilioFiscal']['@attributes']['noInterior'] = '8';
						$arr_xml_cargar['ar6to67be_Emisor']['ar6to67be_DomicilioFiscal']['@attributes']['colonia'] = 'Hipodromo Condesa';
						...
						$arr_xml_cargar['ar6to67be_Emisor']['ar6to67be_DomicilioFiscal']['@attributes']['codigoPostal'] = '06170';

						$arr_xml_cargar['ar6to67be_Emisor']['ar6to67be_ExpedidoEn']['@attributes']['calle'] = 'Acapulco';
						$arr_xml_cargar['ar6to67be_Emisor']['ar6to67be_ExpedidoEn']['@attributes']['noExterior'] = '651';
						$arr_xml_cargar['ar6to67be_Emisor']['ar6to67be_ExpedidoEn']['@attributes']['noInterior'] = '1';
						$arr_xml_cargar['ar6to67be_Emisor']['ar6to67be_ExpedidoEn']['@attributes']['colonia'] = 'Roma';
						$arr_xml_cargar['ar6to67be_Emisor']['ar6to67be_ExpedidoEn']['@attributes']['localidad'] = 'M&eacute;xico';
						$arr_xml_cargar['ar6to67be_Emisor']['ar6to67be_ExpedidoEn']['@attributes']['municipio'] = 'Cuauht&eacute;moc';
						...
						$arr_xml_cargar['ar6to67be_Emisor']['ar6to67be_ExpedidoEn']['@attributes']['codigoPostal'] = '35135';
					...
					$arr_xml_cargar['ar6to67be_Receptor']['@attributes']['nombre'] = 'MOSTRADOR';       
						...
						if ( $invoice_address->firstname != '' && $invoice_address->firstname != null ) {
							...
							$arr_xml_cargar['ar6to67be_Receptor']['@attributes']['nombre'] =  $this->stripAccents( $invoice_address->firstname ); //'Nombre del Receptor';
						...
						if ( $invoice_address->lastname != '' && $invoice_address->lastname != null ) {
							...
							if ( $arr_xml_cargar['ar6to67be_Receptor']['@attributes']['nombre'] != '' ) {
								...
								$arr_xml_cargar['ar6to67be_Receptor']['@attributes']['nombre'] .= " ". $this->stripAccents( $invoice_address->lastname ); //'Nombre del Receptor';
						...
						if ( $invoice_address->address1 != '' && $invoice_address->address1 != null ) {
							$arr_xml_cargar['ar6to67be_Receptor']['ar6to67be_Domicilio']['@attributes']['calle'] =  $this->stripAccents( $invoice_address->address1 ); //'calle obligatoria';
						} else {
			  ...
			  if ( $order_tot->id == $orden_validar  ) {
			  	  echo "<br> antes Sellado emisor:<br><textarea style='height: 574px;  width: 1849px;' style='font-size:13px'>"; echo html_entity_decode( str_replace( array("ar6to67be_", "xmlns_", "xsi_"), array("cfdi:", "xmlns:", "xsi:"), $xml1->saveXML() ) ); echo "</textarea><br><hr>";
