...
//                        die();
			if ( $test_mode == '1') {
				...
				$this->numero_certificado = "00001000000405112669";
				$this->archivo_cer = "xml_timbrado/certi_valido/00001000000405112669.cer"; // old 00001000000304972067.cer"; // Produccion
