...
if( $version<11)
{
    if (!isset($_COOKIE['iexplorerOld'])) {
         setcookie("iexplorerOld", 'iexplorerOld', time()+3600*24*30);
          self::$smarty->assign('iexplorerold','iexplorerold' );
          self::$smarty->assign('lightbox1','lightbox1' );  
         }    
}
}
...
//{echo'This is phone or  tablet<br>'; } else {
//   echo'This is PC<br>';  
// }
// si no es un telefono o una tableta 
if($deviceType!='phone'&&$deviceType!='tablet')
{
 ...
 // si la cookie no existe   
  if (!isset($_COOKIE['newsletter'])) {
         setcookie("newsletter", 'newsletter', time()+3600*24*5);
          self::$smarty->assign('newsletter','newsletter' );
           self::$smarty->assign('lightbox1','lightbox1' );  
         }  
        }
