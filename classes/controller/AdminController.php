...
class AdminControllerCore extends Controller
{
			...
			if (isset($id) && !empty($id))
			{
				...
				if (Validate::isLoadedObject($object))
				{
					...
					else
					{
						...
						/*if($val_savedir == 1 && $val_address_up != '') { // si estoy guardando direccion

							$Id_address = $val_address_up;

							Db::getInstance()->update('address_city', array(
							'id_city' => (int)$val_cityid, ), 'id_address  = '.$Id_address
							);							
	...
	public function initHeader()
	{
		...
		$this->context->smarty->assign(array(
			...
			'currentIndex' => self::$currentIndex
                ...
                $no_permitidas= array ("á","é","í","ó","ú","Ã¡","Ã©","Ã­","Ã³","Ãº","Ã?","Ã","Ã?","Ã","Ã","Ã±","Ã","Ã","Ã","Ã","Ã","Ãâ¢","Ã ","ÃÂ¨","ÃÂ¬","ÃÂ²","ÃÂ¹","Ã§","Ã","ÃÂ¢","Ãª","ÃÂ®","ÃÂ´","ÃÂ»","Ãâ","ÃÅ ","ÃÅ½","Ãâ?","Ãâº","Ã¼","ÃÂ¶","Ãâ","ÃÂ¯","ÃÂ¤","Â«","Ã","ÃÂ?","Ãâ","Ãâ¹");
                $permitidas= array ("a","e","i","o","u","a","e","i","o","u","A","E","I","O","U","n","N","A","E","I","O","U","a","e","i","o","u","c","C","a","e","i","o","u","A","E","I","O","U","u","o","O","i","a","e","U","I","A","E");
                $country = str_replace($no_permitidas, $permitidas ,$country);
                if (!file_exists("../img/flags/".$country.".png")){
                    $country = "Farmalisto";
                }
                $this->context->smarty->assign(array(
                    'shop_country' => $this->selectCountry(),
        ...
        public function selectCountry()
	{
            ...
            $sql_country = 'SELECT `name` FROM `ps_country_lang` WHERE `id_country` = '.$country_default;
            $name_country = Db::getInstance(_PS_USE_SQL_SLAVE_)->getRow($sql_country);
            $name_country = $name_country['name'];
            if (strlen($name_country) >= 33){
                $name_country = substr($name_country, 0, 33)."..."; 
            }
            return $name_country;
	}
