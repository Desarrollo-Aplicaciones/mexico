...
<script type="text/javascript">
	...
	function displaySummary(jsonSummary)
	{
		...
		if (jsonSummary.summary.validacartrule == "true"){
			var total_price = parseInt(jsonSummary.summary.total_price_without_tax.replace(".",""));
			var total_discounts = parseInt(jsonSummary.summary.total_discounts_tax_exc.replace(".",""));
			var total_shipping = parseInt(jsonSummary.summary.total_shipping_tax_exc.replace(".",""));

			totalsinivadescuento = ((total_price + total_shipping) - total_discounts);

			jsonSummary.summary.total_price_without_tax = totalsinivadescuento;

			jsonSummary.summary.total_products = jsonSummary.summary.total_products_recalculado;
		}
