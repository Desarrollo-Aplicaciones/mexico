...
{foreach $list AS $index => $tr}
	...
	>
		<td class="center">
			{if {$has_bulk_actions}}
				...
				{/if}
			{/if}
		</td>{if isset($tr.extras)} {$tr.extras} {/if}
		{foreach $fields_display AS $key => $params}
			...
			{block name="td_content"}
				...
				{if isset($params.color) && isset($tr[$params.color])}
					{if isset($tr.extras) && $tr.extras eq "express"}
						<span style="color:#FFF;text-shadow:none;background-color: #F03D25;padding:5px;border-radius:5px;text-transform:uppercase">
							<img src="../img/os/68.png" />
							&nbsp;{$tr.extras}
						</span>&nbsp;
					{/if}
					{if isset($tr.extras) && $tr.extras eq "entrega_nocturna"}
						<span style="color:#FFF;text-shadow:none;background-color: #0080FF;padding:5px;border-radius:5px;text-transform:uppercase">
							<img src="../img/os/icon_moon.png" />
							&nbsp;NOCTURNO
						</span>&nbsp;
					{/if}  
					{if isset($tr.extras) && $tr.extras eq "express_nocturno"}
						<span style="color:#FFF;text-shadow:none;background-color: #0080FF;padding:5px;border-radius:5px;text-transform:uppercase">
					...
					{elseif isset($params.callback)}<!-- pdf -->
						{$tr.$key}
					{elseif $key == 'color'}
				...
				{/if}
				{if isset($params.suffix)}<!-- Total -->{$params.suffix}{/if}
	...
	{/if}
	{if $has_actions}
		<td class="center" style="white-space: nowrap;"><!-- acciones -->
