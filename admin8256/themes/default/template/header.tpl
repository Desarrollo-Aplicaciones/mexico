...
{* begin  HEADER *}
	<div id="header">
		<div id="header_infos">
                        <a id="header_shopname" href="{$link->getAdminLink('AdminHome')|escape:'htmlall':'UTF-8'}"><span style="height:35px;"><img style="padding: 0px 10px 3px 0px;" src="../img/flags/{$flag_country}.png">{$shop_name}&nbsp;{$shop_country}</span></a>
