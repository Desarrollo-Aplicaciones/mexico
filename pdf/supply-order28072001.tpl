...
<div class="content">
	<table class="container">
		<tr>
			...
			<th style="width: 28%;">{* l s='Designation' pdf='true' *}Nombre</th>
			...
			<th style="width: 8%;">{* l s='Total TE' pdf='true'}{l s='Before discount' pdf='true' *} Subtotal </th>
			<th style="width: 4%;">{* l s='Discount Rate' pdf='true' *}Des %</th>
			<th style="width: 8%;">{* l s='Total TE' pdf='true'}{l s='After discount' pdf='true' *} Total + Des</th>
			<th style="width: 4%;">{* l s='Tax rate' pdf='true' *} Imp % </th>
			<th style="width: 10%;">{* l s='Total TI' pdf='true' *} Total</th>
		</tr>
