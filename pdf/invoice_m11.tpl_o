...
<table style="width: 100%" >
	<tr>
	  ...
	  <td width="50%" style="width: 83%">
        ...
        <p>{/if} </p>
        <p>&nbsp;</p></td>
      <td width="50%" style="width: 17%">
      <b>Factura de Venta:</b>			{$title|escape:'htmlall':'UTF-8'}<br />
...
<table style="width: 100%; font-size: 8pt;">
            ...
            <table style="width: 100%">
				...
				{/if}
				<tr style="line-height:5px;">
					<td style="text-align: right; font-weight: bold">{l s='Discount' pdf='true'}</td>
					<td style="width: 17%; text-align: right;">
            ...
            <table width="100%">
            	<tr>
               	  <td width="48%" style="text-align:justify;"><p><br />Por medio de la presente Factura de Venta, el comprador como propietario, representante legal, su representante delegado o dependiente laboral acepta haber recibido real y materialmente las mercanc&iacute;as y/o servicios descritos en este t&iacute;tulo valor por:<br /><br /><br /><div align="center"></div><br /><Br /><br />
               	  Lo anterior con fundamento en el art&iacute;culo 772 y siguientes del C.C. Modificados por la Ley 1231 del 17 de Julio de 2008</p></td>
                  <td width="4%">&nbsp;</td> 
