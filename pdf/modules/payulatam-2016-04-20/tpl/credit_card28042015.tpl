...
.ui-datepicker-calendar {
 ...
 <div>
     ...
     <div id="formfiles" class="contend-form">
         <div class="cardAttr"><div class="textCard">Número de Tarjeta de Crédito o Débito<span class="purple">*</span>:</div>
                <input type="text" name="card" autocomplete="off" data-openpay-card="card_number" id="numerot" /></div>
         <div class="cardAttr"><div class="textCard">Nombre del Titular<span class="purple">*</span>: </div>
                <input type="text" name="holder" id="nombre" autocomplete="off" data-openpay-card="holder_name" placeholder="Como aparece en la tarjeta" /></div>
         ...
         {html_select_date prefix=NULL end_year="+15" month_format="%m"
            ...
            month_empty="mes" month_extra='id="mes" onchange="cambiaFecha()" data-openpay-card="expiration_month"'
            display_days=false  display_years=false
            field_order="DMY" time=NULL}
            {$year_select}
         </div>
         <div class="cardAttr"><div class="textCard">Número de verificación<span class="purple">*</span>: </div><input type="password" name="cvv" autocomplete="off" data-openpay-card="cvv2" id="codigot" /></div>
        ...
        {*} <img src="https://test.farmalisto.com.mx/themes/gomarket/img/mediosp/openpay.png"> {*}
         <input type="button" id="submit_btn" onclick="$('#botoncitosubmit').click();" class="paymentSubmit" value="Pagar &raquo;">
