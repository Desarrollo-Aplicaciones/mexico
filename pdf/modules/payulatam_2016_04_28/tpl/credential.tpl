...
<form action="{$formCredential|escape:'htmlall':'UTF-8'}" method="POST">
	<fieldset>
		...
		<div class="margin-form">
			<input type="radio" value="1" id="demoyes" name="demo" {if $credentialInputVar['demo']['value'] == '1'}checked="checked"{/if}>  Si
			<input type="radio" value="0" id="demono" name="demo" {if $credentialInputVar['demo']['value'] != '1'}checked="checked"{/if}>  No
		</div>
		<div class="margin-form">
