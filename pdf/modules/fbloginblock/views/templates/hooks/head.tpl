...
$(document).ready(function() {
	...
	{/literal}{if $fbloginblock_topf == "topf" && $fbloginblockf_on == 1}{literal}
		'<a href="javascript:void(0)" onclick="return fblogin();" title="Facebook">'+
			'<img src="{/literal}{$fbloginblockftopimg|escape:'htmlall':'UTF-8'}{literal}" class="width_fbloginblock"  alt="Facebook" />'+
		'</a>&nbsp;'+
		{/literal}
		{/if}
		{if $fbloginblock_topt == "topt" && $fbloginblockt_on == 1}{literal}
			...
			{/literal}{if $fbloginblocktconf == 1}{literal} 
			 ...
			 {/literal}{/if}{literal}
				'title="Twitter">'+
				'<img src="{/literal}{$fbloginblockttopimg|escape:'htmlall':'UTF-8'}{literal}" style="margin-top:12px" alt="Twitter" />'+
			'</a>&nbsp;'+
		{/literal}
		{/if}
		
		{if $fbloginblock_topa == "topa" && $fbloginblocka_on == 1}{literal}
		'<a href="javascript:void(0)" onclick="return amazonlogin();" title="Amazon">'+
			'<img src="{/literal}{$fbloginblockatopimg|escape:'htmlall':'UTF-8'}{literal}" class="width_fbloginblock"  alt="Amazon" />'+
		'</a>&nbsp;'+
		{/literal}
		{/if}
		...
		{/literal}{if $fbloginblockgconf == 1}{literal} 
		 ...
		 {/literal}{else}{literal}
	 	 ...
	 	 {/literal}{/if}{literal}  
		   '>'+
				'<img src="{/literal}{$fbloginblockgtopimg|escape:'htmlall':'UTF-8'}{literal}"  style="margin-top:12px" alt="Google" />'+
			'</a>&nbsp;'+
		{/literal}{/if}
		...
		'<a href="javascript:void(0)" title="Yahoo"'+
		   'onclick="javascript:popupWin = window.open(\'{/literal}{$base_dir_ssl|escape:'htmlall':'UTF-8'}{literal}modules/fbloginblock/login.php?p=yahoo{/literal}{if $fbloginblockorder_page == 1}{literal}&http_referer={/literal}{$fbloginblockhttp_referer|urlencode}{/if}{literal}\', \'openId\', \'location,width=400,height=300,top=0\');popupWin.focus();"'+
			'>'+
			'<img src="{/literal}{$fbloginblockytopimg|escape:'htmlall':'UTF-8'}{literal}" style="margin-top:12px" alt="Yahoo"  />'+
		'</a>&nbsp;'+
		{/literal}{/if}
		...
		'<a href="javascript:void(0)" title="Paypal"'+
		    ...
		    {/literal}{else}{literal}
					  'onclick="alert(\'{/literal}{$perror|escape:'htmlall':'UTF-8'}{literal}\')">'+
			 {/literal}{/if}{literal}
		'<img src="{/literal}{$fbloginblockptopimg|escape:'htmlall':'UTF-8'}{literal}"  style="margin-top:12px" alt="Paypal" />'+
			'</a>&nbsp;'+
		{/literal}{/if}
		...
		{/literal}{else}{literal}
				  'onclick="alert(\'{/literal}{$lerror|escape:'htmlall':'UTF-8'}{literal}\')">'+
		{/literal}{/if}{literal}   
		  	'<img src="{/literal}{$fbloginblockltopimg|escape:'htmlall':'UTF-8'}{literal}"  style="margin-top:12px" alt="LinkedIn" />'+
			'</a>&nbsp;'+
		{/literal}{/if}
		...
		'<img src="{/literal}{$fbloginblockmtopimg|escape:'htmlall':'UTF-8'}{literal}"  style="margin-top:12px" alt="Microsoft Live" />'+
			'</a>&nbsp;'+
		{/literal}{/if}
		
		{if $fbloginblock_topi == "topi" && $fbloginblocki_on == 1}{literal}
		'<a href="javascript:void(0)" title="Instagram"'+
		...
		'<img src="{/literal}{$fbloginblockitopimg|escape:'htmlall':'UTF-8'}{literal}"  style="margin-top:12px" alt="Instagram" />'+
			'</a>&nbsp;'+
		{/literal}{/if}
		
		
		{if $fbloginblock_topfs == "topfs" && $fbloginblockfs_on == 1}{literal}
		'<a href="javascript:void(0)" title="Foursquare"'+
		...
		'<img src="{/literal}{$fbloginblockfstopimg|escape:'htmlall':'UTF-8'}{literal}"  style="margin-top:12px" alt="Foursquare" />'+
			'</a>&nbsp;'+
		{/literal}{/if}
		
		
		{if $fbloginblock_topgi == "topgi" && $fbloginblockgi_on == 1}{literal}
		'<a href="javascript:void(0)" title="Github"'+
		...
		'<img src="{/literal}{$fbloginblockgitopimg|escape:'htmlall':'UTF-8'}{literal}"  style="margin-top:12px" alt="Github" />'+
			'</a>&nbsp;'+
		{/literal}{/if}
		
		
		{if $fbloginblock_topd == "topd" && $fbloginblockd_on == 1}{literal}
		'<a href="javascript:void(0)" title="Disqus"'+
		...
		'<img src="{/literal}{$fbloginblockdtopimg|escape:'htmlall':'UTF-8'}{literal}"  style="margin-top:12px" alt="Disqus" />'+
			'</a>&nbsp;'+
		{/literal}{/if}
...
{literal}
	...
	{literal}
	 '<div class="auth-page-txt-before-logins">{/literal}{$fbloginblockauthp|escape:'quotes':'UTF-8'}{literal}</div>'+
	 {/literal}
		{/if}
	{literal}
	...
	{literal}
	 '<a href="javascript:void(0)" onclick="return fblogin();" title="Facebook">'+
	   '<img src="{/literal}{$fbloginblockfauthpageimg|escape:'htmlall':'UTF-8'}{literal}" alt="Facebook" style="margin-top:12px"  />'+
	 '<\/a>&nbsp;'+
	 {/literal}
	 	{/if}
	...
	{/literal}{/if}{literal} 
	 ...
	 {literal}
	 '<div class="auth-page-txt-info-block">{/literal}{$fbloginblocktxtauthp|escape:'quotes':'UTF-8'}{literal}</div>'+
	 {/literal}
	 {/if}
...
{literal}
	...
	{literal}
       '<a class="fbloginblock-log-in {/literal}{if $fbloginblockis_ps5 == 1 && $fbloginblockis16 == 0}padding-left-logins{/if}{literal}" href="javascript:void(0)"  onclick="return fblogin();" title="Facebook">'+
	   '<img src="{/literal}{$fbloginblockfwelcomeimg|escape:'htmlall':'UTF-8'}{literal}" alt="Facebook"  />'+
	 '<\/a>&nbsp;'+
	 {/literal}
	 	{/if}
	...
	{literal}
	 ...
	 {literal}
	 '<a class="fbloginblock-log-in {/literal}{if $fbloginblockis_ps5 == 1}padding-left-logins{/if}{literal}" href="javascript:void(0)" title="Google" '+
	 {/literal}{if $fbloginblockgconf == 1}{literal} 
	   'onclick="javascript:popupWin = window.open(\'{/literal}{$base_dir_ssl|escape:'htmlall':'UTF-8'}{literal}modules/fbloginblock/login.php?p=google{/literal}{if $fbloginblockorder_page == 1}{literal}&http_referer={/literal}{$fbloginblockhttp_referer|urlencode}{/if}{literal}\', \'openId\', \'location,width=512,height=512,top=0\');popupWin.focus();"'+
	  {/literal}{else}{literal}
			  'onclick="alert(\'{/literal}{$gerror|escape:'htmlall':'UTF-8'}{literal}\')"'+
	  {/literal}{/if}{literal}  
	   '>'+
			'<img src="{/literal}{$fbloginblockgwelcomeimg|escape:'htmlall':'UTF-8'}{literal}" alt="Google"  />'+
		'</a>&nbsp;'+
	 {/literal}
	 {/if}
