...
class SondaPayu extends PayUControllerWS {
  ...
  private $url_reports = "https://stg.api.payulatam.com/reports-api/4.0/service.cgi";
...
public function response_sonda_payu($order, $response_ws){
        ...
        $date = date("Y-m-d H:i:s");
        $sql="INSERT INTO `farmalisto_mx`.`"._DB_PREFIX_."response_sonda_payu` (`id_order`, `id_cart`, `response_ws`, `date_add`, `responseCode`, `id_transaction`, `id_payload`)
