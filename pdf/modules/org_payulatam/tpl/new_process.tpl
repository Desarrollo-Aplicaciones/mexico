...
.ui-datepicker-calendar {
 ...
 <div class="pagocont">
     ...
     <form  method="POST" action="./modules/payulatam/farmapayu.php" id="formPayU" autocomplete="off" >
     ...
     <div id="formfiles" class="contend-form" style="float: none;">
         ...
         <div style="display: inline-block; width: 100%;"> <div style=" min-width: 49%; max-width: 100%; text-align: left;  float: left; padding: 3px;">Fecha de vencimiento*</div><div style=" float: left;   min-width: 49%; max-width: 100%; " > <input style="width: 90%;" type="text" id="datepicker" name="datepicker" class="date-picker" placeholder="mm/yyyy"> </div> </div>
