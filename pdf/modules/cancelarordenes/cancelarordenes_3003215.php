			...
			if( is_numeric( $_POST['orden_cambio'] ) ) {
				...
				if ( $history_order->add() ) {
					...
					if ( Db::getInstance()->insert('order_cambio_state', $insertOrderCambioEstado ) ) {
						...
						$output .= $this->adminDisplayWarning($this->l('Se ha actualizado la orden << '.$_POST['orden_cambio'].' >> al estado Preparación en curso, <br>pero no se insertó el registro de cambios.'));
					}					
