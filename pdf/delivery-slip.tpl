...
{if $date_delivery != "" || $time_delivery != ""}
<table style="width: 100%">
	<tr>
		<td style="width: 20%"></td>
		<td style="width: 80%">
			<br><span style="font-size:16pt;width:600;color:#000;font-weight:600;">Fecha de entrega : </span> <span style="font-size:16pt;width:600;color:#000;font-weight:700;">{$date_delivery}</span><br><span style="font-size:16pt;width:600;color:#000;font-weight:600;">Hora de entrega : </strong> <span style="font-size:16pt;width:600;color:#000;font-weight:700;">{$time_delivery}</span>
		</td>
	</tr>
</table>
...
<table style="width: 100%">
	<tr>
		<td style="width: 22%; padding-right: 7px; text-align: right; vertical-align: top">
			...
			<span style="font-size:16pt!important;width:600;color:#000!important;">{$order->id}</span><br />
			<br />
			<b>{l s='Order Date:' pdf='true'}</b><br />
			<span style="font-size:16pt;width:600;color:#000;">{$order->date_add|date_format:"%D<br>%I:%M %p"}</span><br />
			<br />
			<b>{l s='Payment Method:' pdf='true'}</b><br />
			<table style="width: 100%;">
			{foreach from=$order_invoice->getOrderPaymentCollection() item=payment}
				<tr>
					<td style="width: 50%">{$payment_method}</td>
