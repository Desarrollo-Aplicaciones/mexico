...
<!-- TOTAL -->
	<table>
		...
		<tr>
			<td class="darks">Subtotal</td>
			<td style="text-align: right;">{$currency->prefix} {$sumT|number_format:2:",":"."} {$currency->suffix}</td>
		</tr>
		<tr>
			<td class="darkers">{* l s='Total TI' pdf='true' *}{l s='TOTAL TO PAY' pdf='true'}</td>
			<td class="darkers" style="text-align: right;">{$currency->prefix} {$supply_order->total_ti|number_format:2:",":"."} {$currency->suffix}</td>
		</tr>
	</table>
</td>
<td><br><br><br><br><br>
