...
if($response['code']=='ERROR')
{
 ...
 $conf->failed_transaction(0.0, $customer->id, $data, $response, 'Baloto', 'code=ERROR', $this->context->cart->id,$id_address);
...
{
 $conf->failed_transaction(0.0, $customer->id, $data, $response, 'Baloto', 'code=PAYU_WAITING_PAYMENT', $id_cart,$id_address);
}
else {
     $conf->failed_transaction(0.0, $customer->id, $data, $response, 'Baloto', 'Error indeterminado', $id_cart,$id_address);
