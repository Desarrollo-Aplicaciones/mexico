...
{literal}           
    ...
    <p style="text-align: center; font-weight: bold; font-size: 2em;"> Crear Cupón Médico </p> 
...
{foreach from=$inputs key=campo item=arr_item}
    ...
    {/if}
{/foreach}
            <input type="hidden" name="opc_ini" value="creamed">
            <div style="float: left; margin: 3px; margin-top: 60px; text-align: center; width: 100%;"><input type="submit" value="Guardar" name="savenewcreamed"></div>
        </form>
    </fieldset>
