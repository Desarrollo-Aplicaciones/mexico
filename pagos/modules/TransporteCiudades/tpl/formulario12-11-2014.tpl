...
{* <form action="{$current}&token={$token}&configure=TransporteCiudades" id="target"  method="post"> *}
    <fieldset><legend>{$transciuLogo}</legend>
        ...
        <div class="opciones"> <input type="checkbox" id="express" value="1" onchange="expressEnabled();" {if $expressEnabled} checked{/if}> Habilitar env&iacute;o express </div>
        
        <div id="xps_options" style="float: left; width: 100%; margin: 20px;">
        	<p>Departamento: &nbsp;
