...
class googlehelp extends Module{
	...
	public function userLog($_data){
        ...
        $uri = isset($cookie->http_back) ? $cookie->http_back : $data_order_page['uri'];
        if ( (int)$this->context->cart->nbProducts() ) {
