...
class PayuScotiaBanck extends PayUControllerWS {
...
';
            ...
            if ($response['code'] === 'ERROR') {
                ...
                $conf->failed_transaction(0.0, $customer->id, $data, $response, 'SCOTIABANK', $response['code'], $this->context->cart->id, $id_address);
            ...
            elseif ($response['code'] === 'SUCCESS' && $response['transactionResponse']['state'] === 'PENDING' && $response['transactionResponse']['responseMessage'] != 'ERROR_CONVERTING_TRANSACTION_AMOUNTS') {
                ...
                $extra_vars = array('method' => 'SCOTIABANK',
                ...
                $this->createPendingOrder($extra_vars, 'SCOTIABANK', 'El sistema esta en espera de la confirmación de la pasarela de pago.');
                ...
                $conf->pago_payu($order['id_order'], $customer->id, $data, $response, 'SCOTIABANK', $extras, $id_cart, $id_address);
                ...
                $conf->failed_transaction(0.0, $customer->id, $data, $response, 'SCOTIABANK', $response['transactionResponse']['state'], $id_cart, $id_address);
