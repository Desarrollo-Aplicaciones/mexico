<?php
	function f_convert_text($string){
		...
		$string = preg_replace("/&acirc;/", "â", $string);
		...
		$string = preg_replace("/&Eacute;/", "é", $string);
		$string = preg_replace("/&ecirc;/", "ê", $string);
		$string = preg_replace("/&euml;/", "ë", $string);
		$string = preg_replace("/&icirc;/", "î", $string);
		$string = preg_replace("/&ocirc;/", "ô", $string);
		$string = preg_replace("/&ugrave;/", "ù", $string);
		$string = preg_replace("/&ucirc;/", "û", $string);
		$string = preg_replace("/&rsquo;/", "'", $string);
		$string = preg_replace("/&deg;/", "°", $string);
		// Conversion des monnaies
		$string = preg_replace("/&euro;/", "EUR", $string);
		// Espacement
		$string = preg_replace("/&nbsp;/", " ", $string);	
		// on vires les ;
		$string = preg_replace("/;/", ":", $string);	
