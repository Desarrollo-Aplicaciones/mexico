...
$sql[] = "INSERT INTO `"._DB_PREFIX_."sync_lookup` (`store_id`, `sync_group_name`, `name`, `ref_key`, `is_system`, `created_by`, `dt_created`, `updated_by`, `dt_updated`, `is_active`) VALUES (1, 'cartversioning', '1.5.6.x', '1.5.6', 0, 'admin', now(), 'admin', now(), 1);";
