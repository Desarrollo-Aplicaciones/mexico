				...
				.autocomplete(
					'{if $search_ssl == 1}{$link->getPageLink('search', true)|addslashes}{else}{$link->getPageLink('search')|addslashes}{/if}', {
						...
						if(data == "") {
							...
							document.getElementById('search_query_{$blocksearch_type}').style.background="url('/themes/gomarket/css/modules/blocksearch/img/sin_resultados.jpg') no-repeat right center";
							//$('#search_query_{$blocksearch_type}').val("");
						}
							var mytab = new Array();
